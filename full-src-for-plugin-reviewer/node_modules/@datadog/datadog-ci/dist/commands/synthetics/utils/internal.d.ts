import { BaseResult, BaseTestPayload, BasicAuthCredentials, CookiesObject, ExecutionRule, LocalTriggerConfig, MobileTestWithOverride, Result, ResultInBatch, ResultInBatchSkippedBySelectiveRerun, RetryConfig, ServerResult, Test, TestNotFound, TestPayload, TestSkipped, TestWithOverride, TriggerConfig, UserConfigOverride } from '../interfaces';
...
export declare const getBasePayload: (test: Test, testOverrides?: UserConfigOverride) => BaseTestPayload;
export {};
