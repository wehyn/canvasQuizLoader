...
exports.renderCommandInfo = exports.renderUpload = exports.renderDryRunUpload = exports.renderSuccessfulCommand = exports.renderSuccessfulGitDBSync = exports.renderSuccessfulUpload = exports.renderDeprecatedMention = exports.renderRetriedUpload = exports.renderFailedGitDBSync = exports.renderFailedUpload = exports.renderInvalidFile = void 0;
...
const renderDeprecatedMention = (deprecatedMention, newMention, deprecatedType) => {
    return chalk_1.default.yellow(`${ICONS.WARNING} The "${deprecatedMention}" ${deprecatedType} is deprecated. Please use the "${newMention}" ${deprecatedType} instead.\n`);
};
exports.renderDeprecatedMention = renderDeprecatedMention;
